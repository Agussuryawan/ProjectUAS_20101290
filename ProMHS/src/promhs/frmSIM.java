   ...
   frmmatkul mt;
    ...
    private void MNmhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MNmhsMouseClicked
        if(fr == null || fr.isClosed()){
            fr =new frmmhs();
            label.add(fr);
            fr.setLocation(this.getWidth()/2 - fr.getWidth()/2, this.getHeight()/2-fr.getHeight()/2);
            fr.setVisible(true);
        }else{
            fr.setVisible(true);
        }
    ...
    private void mtkulMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mtkulMouseClicked
      if(mt == null || mt.isClosed()){
          mt = new frmmatkul();
          label.add(mt);
          mt.setLocation(this.getWidth()/3 - mt.getWidth()/3, this.getHeight()/2-mt.getHeight()/3);
          mt.setVisible(true);
      }
